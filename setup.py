...
NAME = "ZenPacks.SteelHouseLabs.ZenossForwarder"
VERSION = "1.0.0"
AUTHOR = "Shane William Scott"
LICENSE = "GPLv2"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.SteelHouseLabs']
PACKAGES = ['ZenPacks', 'ZenPacks.SteelHouseLabs', 'ZenPacks.SteelHouseLabs.ZenossForwarder']
INSTALL_REQUIRES = ['ZenPacks.SteelHouseLabs.EventForwarder']
